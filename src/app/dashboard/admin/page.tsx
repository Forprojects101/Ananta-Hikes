...
function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-inter flex">
      {/* Sidebar Navigation */}
      <aside
        className={`fixed inset-y-0 left-0 z-[60] w-[280px] bg-[#0B1120] text-slate-300 flex flex-col transform transition-transform duration-300 ease-in-out md:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
